...
class WP_Test_Publicize extends WP_UnitTestCase {
	...
	public function setUp() {
		...
		add_filter( 'jetpack_published_post_flags', array( $this, '_is_in_flags' ), 20, 2 );
	}
	...
	function _is_in_flags( $flags, $post ) {
		$this->in_publish_filter = isset( $flags['publicize_post'] ) ? $flags['publicize_post'] : false;
		return $flags;
	}
